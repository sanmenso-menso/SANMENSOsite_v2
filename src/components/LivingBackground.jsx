...
const LivingBackground = ({ isOpening }) => {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-[#f2f5f3]">
            ...
            >
                <h1 className="text-[25vw] leading-[0.8] font-black text-black whitespace-nowrap tracking-tighter transform -translate-y-4">SANMEN</h1>
                <h1 className="text-[25vw] leading-[0.8] font-black text-black whitespace-nowrap tracking-tighter transform translate-y-4 ml-[20vw]">SO.</h1>
            </motion.div>
