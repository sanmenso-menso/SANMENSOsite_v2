        ...
        >
            ...
            >
                ...
                <div className="max-w-7xl mx-auto w-full min-h-full flex flex-col justify-center">
                    <h2 id="history-dialog-title" className="text-5xl md:text-8xl font-black mb-8 md:mb-12 border-b-4 md:border-b-8 border-black inline-block tracking-tighter">
